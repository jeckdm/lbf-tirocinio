...
\begin{document}
    Una volta introdotta l'equazione \ref{eqn:LBFFalsiPositivi} è possibile ricavare un limite inferiore sulla grandezza della struttura una volta definito il tasso di falsi positivi $\epsilon$ desiderato.
