...
\begin{document}
    ...
    \end{flalign*}
    Ricordando che $F_n$ può essere calcolato come rapporto tra chiavi etichettate erroneamente come non chiavi e chiavi totali $m_b/m$, sostituendo ritroviamo l'Equazione \eqref{eqn:SLBFGrandezzaOttima}:
    ...
    È necessario prima di tutto sostituire il valore di $f_b$ in \eqref{eqn:SLBFFalsiPositivi}, per poi risolvere in funzione di $f_{b0}$: 
